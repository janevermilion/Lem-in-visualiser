...
//GLOBAL.document = JSDOM.fromFile('index.html').window.document;
GLOBAL.document = JSDOM.fromFile('index.html');
const restartButton = GLOBAL.document.querySelector('#restart-button');
...
let roomSize = 40;
//let screenWidth = window.screen.width;??node
//let screenHeight = window.screen.height;??node
...
module.exports.draw = function(info) {
    let scale = 1;
    let speed = 500;
